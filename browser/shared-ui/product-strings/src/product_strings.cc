...
std::optional<ProductStrings> BuildProductStrings(
  ...
  ProductStrings strings{
      ...
      browser_mdv::MdvPageStrings{
          ...
          Required(catalog, "mdv.search_placeholder", &complete),
          Required(catalog, "mdv.search_prev", &complete),
          Required(catalog, "mdv.search_next", &complete),
          shortcut_platform},
      PageMarkdownStrings{
...
bool ProductStringsAreComplete(const ProductStrings& strings) noexcept {
  ...
  return present(strings.product_name) && present(new_tab.language) &&
         ...
         present(mdv.outline_label) && present(mdv.search_placeholder) &&
         present(mdv.search_prev) && present(mdv.search_next) &&
