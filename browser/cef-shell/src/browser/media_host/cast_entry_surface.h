...
// exists. The host owns an Alloy toolbar panel, forwards window keys/layout
// changes, calls Tick at least every kTickIntervalMs while visible, and calls
// Detach before close.
...
public:
  ...
  static constexpr int kStatusId = 0xca03;
  static constexpr int kCodeId = 0xca04;
  static constexpr int kPrepareId = 0xca05;
  static constexpr int kConnectId = 0xca07;
  static constexpr int kSessionControlId = 0xca08;
  static constexpr int kStopId = 0xca09;
