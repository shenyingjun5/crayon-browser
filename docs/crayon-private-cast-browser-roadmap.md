...
7. `MRT-01..03 DONE / MRT-04 READY`：`markdown-runtime-v1`、md4c ExtensionNode facts 与编译期 immutable registry/router 已闭合；下一项实现固定 manifest 资源的通用 loader/cache/lifecycle，不提前接具体 renderer。
