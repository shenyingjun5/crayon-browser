...
| RNM | [naming-migration-roadmap.md](naming-migration-roadmap.md) | `get-video` → `crayon-browser` 仓库、包、README、GitHub 与本地路径迁移 | `RNM-01..07 DONE`，`RNM-08 READY` |
...
| 2 | `RNM-08` | READY | GitHub main/README 已同步；最后原子改名本地目录并重建 CMake cache |
