...
| SDK | [cast-sdk-integration-roadmap.md](cast-sdk-integration-roadmap.md) | 固定源码 Cast-SDK facade、发现、连接和控制；后续 Partner Cast facade | `SDK-10 READY` |
...
| 顺序 | 任务 | 状态 | 说明 |
|---:|---|---|---|
| 1 | `SDK-10` | READY | handle 绑定的 play/pause/seek/volume/stop 播控 |
...
- 品牌资产 `BRD-01..04`、Foundation 19 个原子任务、`MED-01..19`、`CEF-01A`、`SDK-01..09` 已完成，共 52 项。
