...
| CNT | [content-intelligence-roadmap.md](content-intelligence-roadmap.md) | 页面数据/Markdown 与第二阶段模型总结 | C1 数据面 `CNT-01..10 DONE/VERIFIED`；一期产品装配 `CNT-17 DONE`、`CNT-18 IN_PROGRESS（18a）`、`CNT-19..21 TODO`；`CNT-11..16` 第二期 |
...
| 顺序 | 任务 | 状态 | 说明 |
|---:|---|---|---|
| 1 | `CNT-18d` | READY | 本地真 CEF fixture 闭合 request → Renderer → gateway → Core owner/extract/Markdown，并覆盖 crash/backpressure |
