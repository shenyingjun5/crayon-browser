...
| CNT | [content-intelligence-roadmap.md](content-intelligence-roadmap.md) | 页面数据/Markdown 与第二阶段模型总结 | C1 数据面 `CNT-01..10 DONE/VERIFIED`；一期产品装配 `CNT-17..18 DONE`、`CNT-19 READY`、`CNT-20..21 TODO`；`CNT-11..16` 第二期 |
...
| 顺序 | 任务 | 状态 | 说明 |
|---:|---|---|---|
| 1 | `CNT-19` | READY | 用户手势触发网页 Markdown，并接通预览、复制、原子保存、取消/覆盖与失败反馈 |
