...
| MRT | [markdown-runtime-roadmap.md](markdown-runtime-roadmap.md) | Markdown Runtime Extension Framework：闭合扩展 API、Highlight/KaTeX 与后续图表/演示门禁 | `MRT-01..03 DONE`，`MRT-04 READY`；`MRT-04..09` 为 P0，`10..19` 分波次推进或仅做 gap analysis |
...
| 7 | `MRT-04` | READY | 实现通用 runtime loader/cache/lifecycle；固定 manifest 资源、按需加载、预算、generation、错误隔离与清理 |
