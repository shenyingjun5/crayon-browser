...
| RNM | [naming-migration-roadmap.md](naming-migration-roadmap.md) | `get-video` → `crayon-browser` 仓库、包、README、GitHub 与本地路径迁移 | `RNM-01..06 DONE`，`RNM-07 READY` |
...
| 2 | `RNM-07` | READY | GitHub 仓库与 origin 已改名并回读；推送 main 并核对 README 首页源 |
