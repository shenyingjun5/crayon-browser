...
| 9 | `MDV-19` | DONE | Mermaid 编辑/多图收口：4 并发/16 等待、会话 LRU、generation fencing、关闭/内存压力清理与 50-block 真实 CEF perf 闭合；下一项为 `MDV-20` 跨平台发布收口 |
