...
| RNM | [naming-migration-roadmap.md](naming-migration-roadmap.md) | `get-video` → `crayon-browser` 仓库、包、README、GitHub 与本地路径迁移 | `RNM-01..03 DONE`，`RNM-04 READY` |
...
| 2 | `RNM-04` | READY | README 与活动文案已迁移；执行新名称下全仓库和 Windows CEF 回归 |
