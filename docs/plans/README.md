...
| CNT | [content-intelligence-roadmap.md](content-intelligence-roadmap.md) | 页面数据/Markdown 与第二阶段模型总结 | C1 数据面 `CNT-01..10 DONE/VERIFIED`；一期产品装配 `CNT-17 DONE`、`CNT-18 READY`、`CNT-19..21 TODO`；`CNT-11..16` 第二期 |
...
| 顺序 | 任务 | 状态 | 说明 |
|---:|---|---|---|
| 1 | `CNT-18` | READY | 接通 Browser 验证 facts 到 Rust owner/extract/Markdown 的生产调用链 |
