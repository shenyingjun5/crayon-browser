...
- 当前开发前沿：`CNT-01..07/09 DONE`、`CNT-08 VERIFIED`、`CNT-10 READY`；AGT A0 权限内核完成，`AGT-06/07/09/12B/15 VERIFIED`，CLI/MCP 仍等产品 transport 装配；`WFL-01 VERIFIED` 且 `WFL-02/04/06 READY`；`HUB-01..06 DONE`。Windows 后续重点是 `PLT-W05` 产品装配与 `MDV-20` 发布回归，`AGT-12C` 需先拆为可审查装配切片；第二阶段模型继续等待 `CNT-10/AGT-16/PRV-13` 与 provider ADR。
