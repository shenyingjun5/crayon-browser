...
- 平台顺序（用户决策，2026-09-08，取代 2026-08-31 顺序）：当前优先在 macOS arm64 构建、调通并完成一期；Windows UI 代码同步改为 Chrome 浏览器风格，Windows 效果后续实机验证。正式签名、公证、Keychain 与发行门禁仍按对应 Roadmap；两个平台证据不能互相替代。
